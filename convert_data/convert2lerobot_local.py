...
def load_data(folder):
    ...
    top_images = extract_frames(os.path.join(folder, "top_camera-images-rgb.mp4"), num_frames)
    left_images = extract_frames(os.path.join(folder, "left_camera-images-rgb.mp4"), num_frames)
    right_images = extract_frames(os.path.join(folder, "right_camera-images-rgb.mp4"), num_frames)
    print(f'Found {len(timestamps)} frames, use {num_frames} frames')
